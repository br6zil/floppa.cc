...
if not isfolder("floppa.cc") then
    makefolder("floppa.cc")
end

if not isfolder("floppa.cc/cfg") then
    makefolder("floppa.cc/cfg")
end

local cfglocation = "floppa.cc/cfg/"
...
local gui = library:New("floppa.cc")
...
local OthersLua = luas:Sector("Others", "Right")
OthersLua:Element("Button", "Unlock Inventory", {}, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/01Leozin/floppa.cc/floppa/luas/Uus3lI6RahKT.lua"))()
end)
OthersLua:Element("Button", "Fake  Rac", {}, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/01Leozin/floppa.cc/floppa/luas/QFeYVxMXrpgw.lua"))()
end)
OthersLua:Element("Button", "Rejoin", {}, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/01Leozin/floppa.cc/floppa/luas/Ew7PL1zRl0RQ.lua"))()
end)
local WP = luas:Sector("Waypoints", "Left")
...
others:Element("Button", "God Mode", {}, function()
    local player = game.Players.LocalPlayer
...
local spammessages = {
    "once i'm kicked, i'll just join another server and repeat the same process.",
    "1'd",
    "are you going to inject??",
    "can't beat me with that skidded cheat?",
    "mad?",
    "did you even execute??",
    "it looks like your face caught on fire and someone tried to put it out with a fork.",
    "don't you love nature, despite what it did to you?",
    "do you know who is "..LocalPlayer.Name.."? the guy who uses floppa.cc and win.",
}

local cwspammsg = {
    "cuteware.xyz",
    "cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware! cuteware!",
    "Who who who?",
    "Looks like you dont have cuteware.xyz!",
    "Buy cuteware.xyz!",
    "Tapped by cuteware, damn.",
    "Do you know who is "..LocalPlayer.Name.."? the guy who uses cuteware.xyz and win."
}
...
animations:Element("Dropdown", "animation", {options = {"Floss", "Default", "Fashionable", "Sleep"}}, function(tbl)
    Dance.AnimationId = tbl.Dropdown == "Floss" and "rbxassetid://5917459365" or tbl.Dropdown == "Default" and "rbxassetid://3732699835" or tbl.Dropdown == "Fashionable" and "rbxassetid://3333331310" or tbl.Dropdown == "Sleep" and "rbxassetid://4686925579"
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)
    ...
    if values.misc.chat["kill say"].Toggle then
        game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "looks like you don't have skid.lol", false, "Innocent", false, true)
    end
end)
